...
const channels = {
    1: {
      ...
      <div class="about-layout">
        <div class="vhs-image">
          <img src="jenpic.png" alt="VHS Tape" />
        </div>
        <div class="info-box">
          <div class="info-title">Hi, My name is Jen!</div>
          <p>
            I am a game and web developer currently studying Digital Media at UCF.<br><br>
            I specialize in spooky projects and unique web experiences! Click the icons below to connect with me and explore the channels for details about my projects.
          </p>
